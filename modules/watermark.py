...
def apply_watermark(doc, text="SAMPLE", orientation="diagonal"):
    # orientation: "diagonal" (default, ~45°) or "horizontal"
    rotation = 'rotation:-45;' if orientation == "diagonal" else ''
